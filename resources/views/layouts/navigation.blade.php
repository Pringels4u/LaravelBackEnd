        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- VOEG DEZE TOE: Link naar de FAQ --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline italic">Log in</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-700 underline italic">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 px-4 space-y-2">
                <a href="{{ route('login') }}" class="block text-base font-medium text-gray-600 italic">Log in</a>
                <a href="{{ route('register') }}" class="block text-base font-medium text-gray-600 italic">Register</a>
            </div>
        @endauth
    </div>
</nav>
